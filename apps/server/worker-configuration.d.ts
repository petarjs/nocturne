/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 04a066c066e8e75f8bddfb38b2e8f2e3)
// Runtime types generated with workerd@1.20260701.1 2026-06-01 
interface __BaseEnv_Env {
	SCENE_DO: DurableObjectNamespace<import("./src/index").SceneDO>;
	REGISTRY_DO: DurableObjectNamespace<import("./src/index").RegistryDO>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "SceneDO" | "RegistryDO";
	}
